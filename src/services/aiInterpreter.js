...
- Las marcas muy cortas o abreviadas del catalogo solo son marca si aparecen como palabra exacta, alias comercial claro o dentro de una referencia de catalogo compatible. Nunca extraigas marcas abreviadas desde verbos o palabras operativas de compra, entrega o pago.
...
- Si el cliente escribe varios productos en un mismo mensaje, en varias lineas o separados por comas/conectores, conserva cada item por separado en "productos". Cada peso, sabor, etapa o variante pertenece solo al producto del mismo segmento de texto. No uses el primer peso del mensaje para los demas productos. Ejemplo: "chunky salmon de 12 kilos y arena kitten de 8 kilos lavanda" debe ser CHUNKY con presentacion 12kg y ARENA con presentacion 8kg.
