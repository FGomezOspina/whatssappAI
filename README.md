...
Los mensajes consecutivos del mismo cliente se agrupan antes de llamar al agente. La ventana local se configura con `INBOUND_MESSAGE_BUFFER_MS`; el valor recomendado para WhatsApp es `2000`.
